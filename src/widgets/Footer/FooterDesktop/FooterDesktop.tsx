			...
			<div className={styles.footerContainer}>
				...
				>
					...
					<div className={classNames(styles.column, styles.columnNarrow)}>
						...
						<div className={styles.support}>
							...
							<div className={styles.supportButtons}>
								...
								>
									<span
										className={classNames(styles.envelop, "icon-email_16__0")}
									/>
								</ButtonOrLink>
								<ButtonOrLink
									className={styles.supportButton}
								...
								>
									<span
										className={classNames(styles.phone, "icon-call_16__0")}
									/>
								</ButtonOrLink>
							</div>
						</div>
					...
					>
						<Link to='https://www.ivi.ru/subscribe'>
							<div className={styles.footerWidget}>
								<div className={styles.footerWidgetIcon}>
									...
									<span
										className={classNames(
											styles.footerWidgetIconAbsolute,
											"icon-noAds_56__1"
										)}
									/>
								</div>
						...
						<Link
							className={styles.footerWidgetText}
							to='https://www.ivi.ru/subscribe'
						>
					...
					<div className={classNames(styles.column, styles.columnWide)}>
						<div className={styles.stores}>
							...
							>
								<div className={styles.storesLinkContainer}>
									<div
										className={classNames(styles.img, "icon-anyDev_20__0")}
									/>
									<div className={styles.textContent}>
